...
${referenceImages && referenceImages.length > 0 ? `USER PROVIDED ${referenceImages.length} REFERENCE IMAGE(S) - These are CRITICAL PRIMARY CONTENT. Preserve them clearly, sharply, and completely (no truncation).` : ''}
